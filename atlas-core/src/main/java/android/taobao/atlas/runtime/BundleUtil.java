...
public class BundleUtil {
     ...
     * @param bundleName
     * @param bundleActivated bundle 已准备完成
     * @param bundleDisabled  bundle 存在故障，需要降级
     */
    public static boolean checkBundleStateAsync(final String bundleName, final Runnable bundleActivated, final Runnable bundleDisabled){
