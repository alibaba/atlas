...
//
//    public synchronized static PatchReceiver get(){
//        if(sReceiver==null){
...
//        IntentFilter filter = new IntentFilter(PATCH_ACTION);
//        application.registerReceiver(get(),filter);
...
//                Toast.makeText(context.getApplicationContext(),"patch installing,be wait for restart...",Toast.LENGTH_LONG).show();
//                new Handler(Looper.getMainLooper()).postDelayed(new PatchRunnable(), 100);
//            }
//        }catch(Exception e){}
//    }
//
