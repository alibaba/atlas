...
public class BundleContext {
    ...
    /**
     * if dex patch happend
     */
    long                dexPatchVersion = -1;
...
//        if (!isValid) {
//            throw new IllegalStateException("BundleContext of bundle " + bundle
...
//     *
//     * @param listener a bundle listener.
...
//        final List<BundleListener> listeners = listener instanceof SynchronousBundleListener ? Framework.syncBundleListeners : Framework.bundleListeners;
//
//        if (bundle.registeredBundleListeners == null) {
//            bundle.registeredBundleListeners = new ArrayList<BundleListener>();
//        }
...
//     *
//     * @param listener a framework listener.
...
//            Framework.frameworkListeners.add(listener);
...
//        Bundle[] bundleArray = (Bundle[]) bundles.toArray(new Bundle[bundles.size()]);
//        Bundle[] allBundles = new Bundle[bundleArray.length + 1];
//        allBundles[0] = Framework.systemBundle;
...
//        checkValid();
//        try {
//            final File file = new File(new File(bundle.bundleDir, "/data/"), filename);
...
//        }
//        checkValid();
//        return Framework.installNewBundle(location);
//    }
//
//    /**
...
//     * @category BundleContext
//     */
//    public Bundle installBundle(final String location, final InputStream in) throws BundleException {
//        if (location == null) {
//            throw new IllegalArgumentException("Location must not be null");
//        }
//        checkValid();
//        return Framework.installNewBundle(location, in);
//    }
//
//    /**
...
//        checkValid();
//        (listener instanceof SynchronousBundleListener ? Framework.syncBundleListeners : Framework.bundleListeners).remove(listener);
...
//        checkValid();
//        Framework.frameworkListeners.remove(listener);
