...
public interface Archive {
    ...
    BundleArchiveRevision newRevision(String location,File bundleDir, File input,String version,long dexPathVersion) throws IOException;
    ...
    File     findLibrary(String fileName);
