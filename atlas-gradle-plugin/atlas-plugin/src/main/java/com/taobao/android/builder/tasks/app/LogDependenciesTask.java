...
public class LogDependenciesTask extends BaseTask {
    ...
    void generate() {
        ...
        stringBuilder.append("gradleVersion:")
                .append(getProject().getGradle().getGradleVersion())
                .append("\r\n");
        stringBuilder.append("mtlVersion:")
                .append(Version.ANDROID_GRADLE_PLUGIN_VERSION)
                .append("\r\n");
        stringBuilder.append("androidVersion:")
                .append(PathUtil.getJarFile(AndroidBuilder.class))
                .append("\r\n");
        try {
    ...
    private List<String> getSortVersionList(AndroidDependencyTree androidDependencyTree) {
        List<String> versionList = new ArrayList<String>();

        try {
            Set<String> depsSet = androidDependencyTree.getFlatDependencies();
