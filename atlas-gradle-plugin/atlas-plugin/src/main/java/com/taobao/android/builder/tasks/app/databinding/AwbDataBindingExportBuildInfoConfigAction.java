...
/**
 * Created by shenghua.nish on 2016-08-11 下午2:10.
 */
public class AwbDataBindingExportBuildInfoConfigAction implements TaskConfigAction<DataBindingExportBuildInfoTask> {
    ...
    public AwbDataBindingExportBuildInfoConfigAction(AppVariantContext appVariantContext, AwbBundle awbBundle, boolean printMachineReadableErrors, DataBindingBuilder dataBindingBuilder) {
    ...
    public String getName() {
        return appVariantContext.getScope().getTaskName("dataBindingExportBuildInfoAwb[" + awbBundle.getName() + "]");
    }
    ...
    public void execute(DataBindingExportBuildInfoTask task) {
        ...
        task.setExportClassListTo(variantData.getType().isExportDataBindingClassList() ?
                new File(appVariantContext.getAwbLayoutFolderOutputForDataBinding(awbBundle), "_generated.txt") : null);
