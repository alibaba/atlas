 ...
 */
public class MergeAwbResourceConfigAction extends MtlBaseTaskAction<MergeResources> {
    ...
    public MergeAwbResourceConfigAction(VariantContext variantContext, BaseVariantOutputData baseVariantOutputData, AwbBundle awbBundle) {
        super(variantContext, baseVariantOutputData);
        this.variantContext = variantContext;
        this.awbBundle = awbBundle;
    }

    public MergeAwbResourceConfigAction(LibVariantContext variantContext, BaseVariantOutputData baseVariantOutputData) {
        super(variantContext, baseVariantOutputData);
        this.variantContext = variantContext;
    ...
    public String getName() {
        return variantContext.getScope().getTaskName("merge", "Resource[" + awbBundle.getName() + "]");
    }
