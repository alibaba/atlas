...
// * Created by shenghua.nish on 2016-05-20 4:04 in the afternoon.
// */
...
//    }
//
//    public MergeAwbAssetConfigAction(LibVariantContext variantContext, BaseVariantOutput baseVariantOutput) {
//        super(variantContext, baseVariantOutput);
//        this.variantContext = variantContext;
...
//        ConventionMappingHelper.map(task, "sourceFolderInputs", (Callable<List<AssetSet>>) () -> {
...
//            return assetSets;
//        });
//        ConventionMappingHelper.map(task, "outputDir", (Callable<File>) () -> {
...
////            appVariantContext.().put(awbBundle.getName(), task);
////        }
//    }
//}
