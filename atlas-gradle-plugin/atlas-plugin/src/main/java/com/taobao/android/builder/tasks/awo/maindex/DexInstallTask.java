...
public class DexInstallTask extends BaseTask {
    ...
    public void setKernelSoFile(File kernelSoFile) {
        this.kernelSoFile = kernelSoFile;
    }

    public static class ConfigAction extends MtlBaseTaskAction<DexInstallTask> {
        ...
        @Override
        public Class<DexInstallTask> getType() {
            return DexInstallTask.class;
        }

        @Override
        public void execute(DexInstallTask task) {
            ...
            ConventionMappingHelper.map(task, "kernelSoFile", new Callable<File>() {
