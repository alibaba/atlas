...
public class AwbBundle {
    ...
    public String getPackageName() {
        ...
        if (StringUtils.isEmpty(packageName)) {
            ...
            DefaultManifestParser defaultManifestParser = new DefaultManifestParser(manifest);
            packageName = defaultManifestParser.getPackage();
            // try {
            //     try (JarFile jarFile = new JarFile(manifest)) {
            ...
            //                 throw new DefaultManifestParserException(manifest, e);
            //             }
            //         }
            //     }
            // } catch (IOException e) {
