...
public class AtlasBuildContext {
    ...
    public static Map<String, AndroidDependencyTree> androidDependencyTrees = Maps.newHashMap();
    public static Map<String, AndroidDependencyTree> libDependencyTrees = Maps.newHashMap();
