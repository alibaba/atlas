...
public class AwbProguardConfiguration {
    ...
    public AwbProguardConfiguration(Collection<AwbTransform> awbTransforms, File awbObfuscatedDir,
    ...
    public void printConfigFile(File outConfigFile) throws IOException {
        ...
        for (AwbTransform awbTransform : awbTransforms) {
            ...
            File obuscateFile = new File(awbObfuscatedDir,
                                         awbTransform.getAwbBundle().getName() + File.separator + OBUSCATED_JAR);
