package com.taobao.android.builder.tasks.transform.arouter.core
...
import com.taobao.android.builder.tasks.transform.arouter.utils.ScanUtil
        ...
        inputs.each { TransformInput input ->
            ...
            input.jarInputs.each { JarInput jarInput ->
                ...
                if (AtlasBuildContext.atlasMainDexHelper.inMainDex(jarInput)){
                    AtlasBuildContext.atlasMainDexHelper.updateMainDexFile(jarInput,dest)
                }
