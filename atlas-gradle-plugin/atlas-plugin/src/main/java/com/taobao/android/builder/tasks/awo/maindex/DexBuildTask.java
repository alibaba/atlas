...
import com.taobao.android.builder.tools.jarmerge.JarMergerWithOverride;
...
public class DexBuildTask extends DefaultAndroidTask {
    ...
    private File classJar;

    public File outputDexFile;

    public List<File> dependencyJars;
    ...
    public static class ConfigAction extends MtlBaseTaskAction<DexBuildTask> {
        ...
        public String getName() {
            return scope.getTaskName("buildDex");
        }

        @Override
        public Class<DexBuildTask> getType() {
            return DexBuildTask.class;
        }
