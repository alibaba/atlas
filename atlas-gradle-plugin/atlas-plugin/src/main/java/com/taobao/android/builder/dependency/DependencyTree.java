...
/**
 * 项目的依赖树信息
 * Created by shenghua.nish on 2016-05-05 上午10:27.
 */
public class DependencyTree {
    ...
    public void addDependencies(List<ResolvedDependencyInfo> dependencies) {
        mResolvedDependencies.addAll(dependencies);
    }

    public void addDependency(ResolvedDependencyInfo dependencyInfo) {
        mResolvedDependencies.add(dependencyInfo);
    }
    ...
    private void toStr(StringBuilder sb,
        ...
        sb.append(tab).append(SEQ).append(resolvedDependencyInfo.toString()).append("\n");
        tab = tab + BLANK;
