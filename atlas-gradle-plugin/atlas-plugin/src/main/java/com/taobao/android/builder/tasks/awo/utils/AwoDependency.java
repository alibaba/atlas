...
/**
 * Created by wuzhong on 16/7/29.
 */
public class AwoDependency {

    public AwoDependency(LibVariantContext libVariantContext) {
        this.libVariantContext = libVariantContext;
        collectLibraryJars(libVariantContext);
    }

    public void parseDependency(AtlasDependencyTree libDependencyTree, AwbBundle awbBundle) {
    ...
    private boolean isCompileDependency(MavenCoordinates mavenCoordinates) {
        String key = mavenCoordinates.getGroupId() + "-" + mavenCoordinates.getArtifactId();
        return compileDependencies.contains(key);
    }
    ...
    public void setCompileDependencies(Set<String> compileDependencies) {
