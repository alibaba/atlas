 ...
 */
public class LibClassRefVisitor implements ClassVisitor, ConstantVisitor, MemberVisitor {
    ...
    @NotNull
    private ClazzRefInfo getRefInfo(String clazzName) {
    ...
    @NotNull
    private ClazzInfo getClazzInfo(String clazzName) {
