...
public class ManifestFileObject {
    ...
    public ManifestFileObject addManifestProperty(String key,String value){
    ...
    public ManifestFileObject addApplicationProperty(String key,String value){
    ...
    public ManifestFileObject addUseSdkProperty(String key,String value){
