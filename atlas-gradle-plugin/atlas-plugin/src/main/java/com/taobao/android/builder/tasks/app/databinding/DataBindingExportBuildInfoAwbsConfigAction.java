...
public class DataBindingExportBuildInfoAwbsConfigAction extends MtlBaseTaskAction<MtlParallelTask> {


    private AppVariantContext appVariantContext;

    public DataBindingExportBuildInfoAwbsConfigAction(AppVariantContext appVariantContext, BaseVariantOutputData baseVariantOutputData) {
    ...
    public void execute(MtlParallelTask parallelTask) {
        ...
        for (final AwbBundle awbBundle : androidDependencyTree.getAwbBundles()) {
            ...
            DataBindingExportBuildInfoTask exportBuildInfoTask = TaskCreater.create(appVariantContext.getProject(), exportBuildInfoConfigAction.getName(),
                    exportBuildInfoConfigAction.getType());
