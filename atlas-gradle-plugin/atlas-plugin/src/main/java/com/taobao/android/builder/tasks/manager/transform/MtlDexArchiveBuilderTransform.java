...
public class MtlDexArchiveBuilderTransform extends Transform {
    ...
    public void transform(@NonNull TransformInvocation transformInvocation)
        ...
        try (ClassFileProviderFactory bootClasspathProvider =
            ...
            if ((variantOutputContext.getVariantContext().getAtlasExtension().isAppBundlesEnabled()||variantOutputContext.getVariantContext().getAtlasExtension().isFlexaEnabled()) && variantOutputContext.getVariantContext().getAtlasExtension().getTBuildConfig().getDynamicFeatures().size() > 0){
