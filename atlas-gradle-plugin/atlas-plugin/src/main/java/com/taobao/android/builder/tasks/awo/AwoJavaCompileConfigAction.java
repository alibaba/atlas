 ...
 */
public class AwoJavaCompileConfigAction extends MtlBaseTaskAction<JavaCompile> {

    private static final ILogger LOG = LoggerWrapper.getLogger(AwoJavaCompileConfigAction.class);
    private AwbBundle awbBundle;
    private LibVariantContext libVariantContext;
    private VariantScope scope;


    public AwoJavaCompileConfigAction(LibVariantContext variantContext, BaseVariantOutputData baseVariantOutputData) {
