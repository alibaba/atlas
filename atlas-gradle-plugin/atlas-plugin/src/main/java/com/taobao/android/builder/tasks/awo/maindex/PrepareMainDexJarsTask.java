...
public class PrepareMainDexJarsTask extends BaseTask {
    ...
    public void doFullTaskAction() {
        ...
        AtlasDependencyTree libDependencyTree = AtlasBuildContext.libDependencyTrees.get(this.getVariantName());
    ...
    public static class ConfigAction extends MtlBaseTaskAction<PrepareMainDexJarsTask> {
        ...
        public String getName() {
            return scope.getTaskName("prepare", "MainDexJars");
        }

        @NonNull
        @Override
        public Class<PrepareMainDexJarsTask> getType() {
            return PrepareMainDexJarsTask.class;
        }


        @Override
        public void execute(@NonNull PrepareMainDexJarsTask prepareAwoDependncyTask) {

            super.execute(prepareAwoDependncyTask);

            prepareAwoDependncyTask.libVariantContext = libVariantContext;
