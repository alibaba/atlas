...
public class DataBindingProcessLayoutAwbsConfigAction extends MtlBaseTaskAction<MtlParallelTask> {

    private AppVariantContext appVariantContext;

    public DataBindingProcessLayoutAwbsConfigAction(AppVariantContext appVariantContext, BaseVariantOutputData baseVariantOutputData) {
