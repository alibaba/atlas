...
public class NativeSoUtils {
    ...
    public static void copyLocalNativeLibraries(final File localNativeLibrariesDirectory,
                                                final File destinationDirectory, Set<String> supportAbis,Set<String> removeSoFiles, ILogger mLogger)
                                                                                                             {
        mLogger.info("Copying existing native libraries from " + localNativeLibrariesDirectory + " to "
