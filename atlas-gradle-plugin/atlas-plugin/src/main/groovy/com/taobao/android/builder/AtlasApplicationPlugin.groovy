...
class AtlasApplicationPlugin extends BasePlugin implements Plugin<Project> {

    @Inject
    public AtlasApplicationPlugin(Instantiator instantiator, ToolingModelBuilderRegistry registry) {
    ...
    @Override
    protected TaskManager createTaskManager(Project project,
    ...
    void apply(Project project) {
        ...
        project.tasks.create(name: 'atlasConfigList') << {
            ...
            List<AtlasConfigField> list = AtlasConfigHelper.readConfig(atlasExtension);
            ...
            for (AtlasConfigField configField : list) {
                lines.add(
                        configField.desc + "  | " + configField.name + " | " + configField.type + "  | " + configField.value);
            }
