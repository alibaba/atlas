        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_notifications:
                    new AlertDialog.Builder(MainActivity2.this,R.style.Theme_AppCompat_Dialog_Alert).setPositiveButton(android.R.string.cancel, null).setCancelable(true).create().show();
...
//                    mActivityDelegate.execStartChildActivityInternal(mActivityGroupContainer,"third",intent3);
    ...
    void switchToFirstFragment(){
        ...
        RemoteFactory.requestRemote(RemoteFragment.class, this, new Intent("atlas.fragment.intent.action.FIRST_FRAGMENT"),
    ...
    void switchToSecondFragment(){
        ...
        RemoteFactory.requestRemote(RemoteFragment.class, this, new Intent("atlas.fragment.intent.action.SECOND_FRAGMENT"),
                new RemoteFactory.OnRemoteStateListener<RemoteFragment>() {
                    @Override
                    public void onRemotePrepared(RemoteFragment iRemote) {
                        getSupportFragmentManager().beginTransaction().replace(R.id.fl_content,iRemote).commit();
